        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-28 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-9 absolute left-3 md:left-3 w-9 rounded-full bg-background/80 dark:bg-background/80 backdrop-blur-xl border border-border flex items-center justify-center ring-2 ring-primary/30">
                <div className="h-3 w-3 rounded-full bg-primary/30 border border-primary/60" />
              </div>
              <HeadingScramble
                as="h3"
        ...
        >
          <motion.div
            ...
            className={cn(
              ...
              "bg-gradient-to-t from-primary via-accent/60 to-transparent"
            )}
          />
        </div>
      </div>
