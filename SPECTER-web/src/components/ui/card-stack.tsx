...
/**
 * Internal `/route` links use react-router; absolute `http(s)://` links use a
 * plain anchor. (Adapted from the original next/link implementation.)
 */
function SmartLink({
  href,
  className,
  ...
  return (
    <RouterLink to={href} className={className} aria-label={ariaLabel}>
      {children}
    </RouterLink>
  );
}
