...
export type LoaderContext = {
  ...
  readonly AnnouncementEvent: {
    /**
     * Load the entity AnnouncementEvent from the storage by ID.
     * If the entity is not found, returns undefined.
     */
    readonly get: (id: string) => Promise<Entities.AnnouncementEvent_t | undefined>,
    /**
     * Load the entity AnnouncementEvent from the storage by ID.
     * If the entity is not found, throws an error.
     */
    readonly getOrThrow: (id: string, message?: string) => Promise<Entities.AnnouncementEvent_t>,
    readonly getWhere: Entities.AnnouncementEvent_indexedFieldOperations,
    /**
     * Returns the entity AnnouncementEvent from the storage by ID.
     * If the entity is not found, creates it using provided parameters and returns it.
     */
    readonly getOrCreate: (entity: Entities.AnnouncementEvent_t) => Promise<Entities.AnnouncementEvent_t>,
    /**
     * Set the entity AnnouncementEvent in the storage.
     */
    readonly set: (entity: Entities.AnnouncementEvent_t) => void,
    /**
     * Delete the entity AnnouncementEvent from the storage.
     *
